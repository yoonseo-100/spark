...
export default function ApplicationForm() {
  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2">
        <label
          className="block text-justify tracking-wide text-grey-darker   mb-2 after:content-['*']"
          htmlFor="package"
        >
          {language === "en"
      ...
      <div className="md:col-span-2  ">
        ...
        >
          {language === "en"
            ...
            : "Amerika'da hangi düzeyde eğitim almak istiyorsunuz?"}
        </label>
        <select
          className="appearance-none block w-full  text-grey-darker outline-none   border-none  rounded py-3 px-4 mb-3 bg-white dark:bg-LIGHT_SECONDARY_BG_COLOR dark:text-black"
      ...
      <div className="md:col-span-2  ">
        <label
          className="block text-justify tracking-wide text-grey-darker   mb-2 :content-['*']"
