...
export default function Footer() {
  ...
  return (
    <footer
      ...
      ref={footerRef}
    >
      <div className="flex gap-16 dark:invert">
        <Link
          href="https://instagram.com/heliosadmissions?igshid=MzRlODBiNWFlZA=="
        ...
        <Link
          href="https://www.youtube.com/channel/UCOTCKbVdCM9OSWWjmUjpwkQ"
          rel="noopener noreferrer"
          target="_blank"
          className="hover:cursor-pointer hover:scale-150 transition-all duration-300 active:scale-90"
        >
